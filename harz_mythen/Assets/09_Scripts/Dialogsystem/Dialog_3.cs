        ...
        */
        ...
        public void TextStart() // Sprechblasen - Start
        {
            ...
            if (DialogActivation.characterNumber == 2)
            {
                ...
                if (speechbubbleRomarIsActive == true)
                {
                    textComponent.text = "Ach, meine Ruma. Wie sehr ich dich vermisse….";
                    end = true;
                }
                if (Input.GetMouseButtonDown(0))
                {
                    if (speechbubbleRomarIsActive == false)
                    {
                        speechbubbleRomarIsActive = true;
                        Debug.Log("speechbubbleRomarIsActive: " + speechbubbleRomarIsActive);
                    }
                    if (end == true)
                    {
                        speechbubbleRomarIsActive = false;
                        end = false;
                        Debug.Log("speechbubbleRomarIsActive: " + speechbubbleRomarIsActive);
                        End();
                    }
